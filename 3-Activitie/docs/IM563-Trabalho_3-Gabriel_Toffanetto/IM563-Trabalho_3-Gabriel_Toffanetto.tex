...
\def\Disciplina{Processamento de Imagens \\ Aplicado  à Automação e Robótica}   
\def\DisciplinaCOD{IM563}                                     
\def\Professor{Paulo R. G. Kurka}                                      
\def\Titulo{Trabalho 3}                                          
\def\TituloShort{Trabalho 3}                                           
